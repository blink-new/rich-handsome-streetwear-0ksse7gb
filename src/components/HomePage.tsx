      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="font-anton text-4xl md:text-5xl chrome-text mb-6">
                THE PHILOSOPHY
              </h2>
              <p className="text-white/80 text-lg font-inter leading-relaxed mb-6">
                Rich Hand$ome isn't just clothing—it's a statement. We create pieces for individuals 
                who understand that true luxury comes from within, and style is the external 
                manifestation of inner confidence.
              </p>
              <p className="text-white/80 text-lg font-inter leading-relaxed mb-8">
                Every piece is crafted with premium materials and attention to detail that 
                reflects our commitment to excellence. When you wear Rich Hand$ome, you're not 
                just wearing clothes—you're wearing a mindset.
              </p>
              <button
                onClick={() => onNavigate('about')}
                className="text-accent font-inter font-medium tracking-wider hover:text-white transition-colors duration-300 flex items-center gap-2"
              >
                LEARN MORE ABOUT US
